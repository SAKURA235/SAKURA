...
os.execute('wget https://raw.githubusercontent.com/SAKURA235/SAKURA/master/Tshake.lua')
os.execute('wget https://raw.githubusercontent.com/SAKURA235/SAKURA/master/start.lua')
dofile('Tshake.lua')  
return false
end
